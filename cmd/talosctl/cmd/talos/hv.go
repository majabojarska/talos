...
// hvCmd represents the hv command.
...
// contentLibraryCmd represents the hv content-library command.
...
// contentLibraryListCmd represents the hv content-library list command.
...
// contentLibraryUploadCmd represents the hv content-library upload command.
...
func contentLibraryUpload(ctx context.Context, libraryID, filename string) error {
	...
	ctx, c, node, err := clientFactory.BuildClientEnforceSingleNode(ctx, "talosctl hv content-library upload")
	if err != nil {
		return err
	}
...
// contentLibraryDeleteCmd represents the hv content-library delete command.
...
func init() {
	...
	hvCmd.AddCommand(contentLibraryCmd)
	addCommand(hvCmd)
}
