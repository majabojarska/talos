...
func setup(t *testing.T, ready bool) (*contentlibrary.Service, string) {
	...
	contentLibraryStatus := hv.NewContentLibraryStatus(hv.NamespaceName, testLibrary)
...
func TestStaleStagedUploadDoesNotBlock(t *testing.T) {
	...
	stale := filepath.Join(path, ".image.raw.0123456789abcdef"+constants.ContentLibraryInflightUploadSuffix)
