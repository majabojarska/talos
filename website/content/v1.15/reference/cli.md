...
## talosctl hv content-library delete

Delete a file from a content library

```
talosctl hv content-library delete <library_id> <filename> [flags]
```
...
* [talosctl hv content-library](#talosctl-hv-content-library)	 - Manage the contents of content libraries

## talosctl hv content-library list

List the files stored in a content library

```
talosctl hv content-library list <library_id> [flags]
```
...
## talosctl hv content-library upload
...
```
talosctl hv content-library upload <library_id> <filename> [flags]
```
...
* [talosctl hv](#talosctl-hv)	 - Manage the Talos hypervisor
* [talosctl hv content-library delete](#talosctl-hv-content-library-delete)	 - Delete a file from a content library
* [talosctl hv content-library list](#talosctl-hv-content-library-list)	 - List the files stored in a content library
* [talosctl hv content-library upload](#talosctl-hv-content-library-upload)	 - Upload a file to a content library
