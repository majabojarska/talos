...
//
// Structurally identical to ContainerUserVolumeMountConfig, but kept separate: the two name
// different document kinds and their mount option defaults differ.
//
//nolint:iface
