...
//go:generate go tool github.com/siderolabs/talos/tools/docgen -output container_doc.go container.go container_config.go mounts.go runtime.go security.go
