...
// TextFilesConfigs implements config.Config interface.
func (container *Container) TextFilesConfigs() []config.TextFilesConfig {
	return findMatchingDocs[config.TextFilesConfig](container.documents)
}
