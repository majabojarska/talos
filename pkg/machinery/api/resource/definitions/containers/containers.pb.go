...
func (x *ContainerImageStatusSpec) GetProgress() string {
	if x != nil {
		return x.Progress
	}
	return ""
...
func (x *ContainerInstanceSpecSpec) GetUser() string {
	if x != nil {
		return x.User
	}
	return ""
...
func (x *ContainerSpecSpec) GetUser() string {
	if x != nil {
		return x.User
	}
	return ""
...
const file_resource_definitions_containers_containers_proto_rawDesc = "" +
	...
	"\bprogress\x18\x04 \x01(\tR\bprogress\x12\x14\n" +
	"\x05error\x18\x05 \x01(\tR\x05error\"\xdf\x04\n" +
...
var file_resource_definitions_containers_containers_proto_goTypes = []any{
	...
	(*ContainerImageStatusSpec)(nil),            // 1: talos.resource.definitions.containers.ContainerImageStatusSpec
	(*ContainerInstanceSpecSpec)(nil),           // 2: talos.resource.definitions.containers.ContainerInstanceSpecSpec
	(*ContainerInstanceStatusSpec)(nil),         // 3: talos.resource.definitions.containers.ContainerInstanceStatusSpec
	(*ContainerMountSpec)(nil),                  // 4: talos.resource.definitions.containers.ContainerMountSpec
	(*ContainerMountStatusSpec)(nil),            // 5: talos.resource.definitions.containers.ContainerMountStatusSpec
	...
	(*ContainerStatusSpec)(nil),                 // 10: talos.resource.definitions.containers.ContainerStatusSpec
	...
	(enums.ContainersContainerState)(0),         // 15: talos.resource.definitions.enums.ContainersContainerState
	(enums.ContainersContainerHealth)(0),        // 16: talos.resource.definitions.enums.ContainersContainerHealth
}
var file_resource_definitions_containers_containers_proto_depIdxs = []int32{
	...
	11, // 1: talos.resource.definitions.containers.ContainerInstanceSpecSpec.mounts:type_name -> talos.resource.definitions.containers.ResolvedMountSpec
	8,  // 2: talos.resource.definitions.containers.ContainerInstanceSpecSpec.security:type_name -> talos.resource.definitions.containers.ContainerSecuritySpec
	6,  // 3: talos.resource.definitions.containers.ContainerInstanceSpecSpec.network:type_name -> talos.resource.definitions.containers.ContainerNetworkSpec
	7,  // 4: talos.resource.definitions.containers.ContainerInstanceSpecSpec.resources:type_name -> talos.resource.definitions.containers.ContainerResourcesSpec
	13, // 5: talos.resource.definitions.containers.ContainerInstanceStatusSpec.phase:type_name -> talos.resource.definitions.enums.ContainersContainerInstancePhase
	14, // 6: talos.resource.definitions.containers.ContainerInstanceStatusSpec.started_at:type_name -> google.protobuf.Timestamp
	14, // 7: talos.resource.definitions.containers.ContainerInstanceStatusSpec.finished_at:type_name -> google.protobuf.Timestamp
	11, // 8: talos.resource.definitions.containers.ContainerMountStatusSpec.mounts:type_name -> talos.resource.definitions.containers.ResolvedMountSpec
	4,  // 9: talos.resource.definitions.containers.ContainerSpecSpec.mounts:type_name -> talos.resource.definitions.containers.ContainerMountSpec
	8,  // 10: talos.resource.definitions.containers.ContainerSpecSpec.security:type_name -> talos.resource.definitions.containers.ContainerSecuritySpec
	6,  // 11: talos.resource.definitions.containers.ContainerSpecSpec.network:type_name -> talos.resource.definitions.containers.ContainerNetworkSpec
	7,  // 12: talos.resource.definitions.containers.ContainerSpecSpec.resources:type_name -> talos.resource.definitions.containers.ContainerResourcesSpec
	0,  // 13: talos.resource.definitions.containers.ContainerSpecSpec.depends_on:type_name -> talos.resource.definitions.containers.ContainerDependsOnSpec
	15, // 14: talos.resource.definitions.containers.ContainerStatusSpec.state:type_name -> talos.resource.definitions.enums.ContainersContainerState
	16, // 15: talos.resource.definitions.containers.ContainerStatusSpec.health:type_name -> talos.resource.definitions.enums.ContainersContainerHealth
