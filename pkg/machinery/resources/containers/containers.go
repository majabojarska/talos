...
//go:generate go tool github.com/siderolabs/deep-copy -type ContainerSpecSpec -type ContainerImageStatusSpec -type ContainerMountStatusSpec -type ContainerInstanceSpecSpec -type ContainerInstanceStatusSpec -type ContainerLifecycleSpec -type ContainerStatusSpec -type TextFilesStatusSpec -header-file ../../../../hack/boilerplate.txt -o deep_copy.generated.go .
