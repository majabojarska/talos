...
const (
	...
	// ContentLibraryDirectory is the directory on the backing volume holding the content libraries,
	// one subdirectory per library, so several libraries may share a volume.
	ContentLibraryDirectory = "content-library"
